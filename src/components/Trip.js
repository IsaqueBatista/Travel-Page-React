    ...
    <div className="trip">
      ...
      <div className="tripcard">
        ...
        <TripData
          ...
          text="Malysia is a Southeast Asian country occupying parts os the Malay
        ...
        <TripData
          ...
          text="France, in Westerm Europe, encompasses medieval cities, alpine
          villages and Mediterranean beaches. Paris, its capital, is famed for its
          fashion houses, classical art museums including the Louvre and 
