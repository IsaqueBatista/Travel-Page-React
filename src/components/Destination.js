  ...
  return (
    <div className="destination">
      ...
      <DestinationData
        ...
        Taal boats a volcano inside a look, the hike up to the 
        ...
        steam vents. The hike can be dusty and hot, so plan for an early morning 
        trip, and then unwind with some bulalo before heading back home!"
        img1={Mountain1}
        img2={Mountain2}
      />
      ...
      <DestinationData
        ...
        text="If you're looking for a hike that's a little more challenging but
        still good for a beginner mountainner, check out Mt.
        ...
        breeze is fantastic. Once you've made it back down, head straight
